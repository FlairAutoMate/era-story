    ...
    <>
      ...
      <ol className="steps">
        {["Kartlegging", "Velg pakke", "Aksepter tilbud", "Følg arbeidet"].map((s, i) => (
          <li key={s} aria-current={step === i + 1 ? "step" : undefined} className={step > i + 1 ? "done" : ""}><span className="n">{i + 1}</span>{s}</li>
        ))}
      </ol>
      ...
      <div className="split">
        ...
        <div className="stack">
          <Card pad className="stack" data-testid="resident-quote">
